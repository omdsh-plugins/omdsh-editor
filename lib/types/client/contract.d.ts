...
export interface EditorPickerInjected {
    ...
    hooks: {
        editorPicker: ObservableSnapshot<EditorPickerState>;
    };
    /**
...
export type EditorPickerProps = PropsRuntime<'conversation.session.header.utilities'> & InjectFace<EditorPickerInjected> & PropsLocale<'editor'>;
