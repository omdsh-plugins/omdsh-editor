...
export const ROUTE_PREFIX = '/omdsh-editor'

/** The editors this host actually has, as the picker lists them. */
export const EDITORS_PATH = `${ROUTE_PREFIX}/editors`

/** Launch one of them on a session's directory. */
export const OPEN_PATH = `${ROUTE_PREFIX}/open`
 ...
 */
export const ICON_PATH = `${ROUTE_PREFIX}/icon`
...
export interface EditorErrorBody {
  error: { code: EditorErrorCode; message: string }
}
